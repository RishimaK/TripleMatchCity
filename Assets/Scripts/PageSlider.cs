...
public class PageSlider : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public Sprite Footer_fr1;
    public Sprite Footer_fr2;
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            if(isMove)
            {
                if (i == page)
                {
                    ...
                    icon.GetComponent<RectTransform>().DOScale(new Vector3(1.1f, 1.1f, 1), 0.2f);
                ...
                else
                {
                    ...
                    if(i == curentPage) 
                    {
                        ...
                        icon.GetComponent<RectTransform>().DOScale(new Vector3(0.8f, 0.8f, 1), 0.2f);
    ...
    void CheckBtn()
    {
        ...
        FrChoosen.GetComponent<RectTransform>().localPosition = new Vector2(0, _height / 2);
